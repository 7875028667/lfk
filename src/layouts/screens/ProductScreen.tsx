...
const ProductScreen = ({ navigation }: any) => {
  ...
  const fetchData = async () => {
    try {
      const api: any = await getMethod('products');
      if (api.status === 200) {
        ...
        <Pressable>
          <View style={styles.body}>
            ...
            <View style={styles.searchContianer}>
              <Text style={styles.home}>Products</Text>
            </View>
              ...
              <View style={{ paddingBottom: 20 }}>
                <ScrollView>
                  <RadioButton.Group onValueChange={handleRadioButtonChangeCategory} value={checked}>
                    {/* <RadioButton.Item label="Category 1" value="1" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 2" value="2" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 3" value="3" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 4" value="4" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 5" value="5" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 6" value="6" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 7" value="7" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 8" value="8" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 9" value="9" color="red" labelStyle={{}} />
                    <RadioButton.Item label="Category 10" value="10" color="red" labelStyle={{}} /> */}
